      ...
      <Animatable.View
        ...
        <View style={styles.contactDropdown}>
          <Button
            ...
            <Icon style={{fontSize: 23, color: 'green'}} name="call" />
          </Button>
          <Button
            rounded
            style={styles.biWhite}
            onPress={() => Linking.openURL(`sms:${item.phone}`)}>
            <Icon type="FontAwesome" name="edit" style={{color: 'coral'}} />
          </Button>
          <Button rounded style={styles.biWhite} onPress={() => alert('blok')}>
            <Icon type="FontAwesome" name="camera" style={{color: 'green'}} />
          </Button>
          <Button rounded style={styles.biWhite} onPress={() => alert('blok')}>
    ...
    <Container>
      ...
      <Footer>
        <FooterTab style={{backgroundColor: '#172F2D'}}>
          <Button>
            <Icon name="arrow-back" style={styles.clrWhite} />
            <Text style={styles.clrWhite}>Back</Text>
          </Button>
          <Button>
            <Icon name="home" style={styles.clrWhite} />
            <Text style={styles.clrWhite}>Home</Text>
          </Button>

          <Button>
            <Icon name="menu" style={styles.clrWhite} />
            <Text style={styles.clrWhite}>Menu</Text>
          </Button>
        </FooterTab>
      </Footer>
    </Container>
