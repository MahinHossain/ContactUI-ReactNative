  ...
  const _renderHeader = (item, expanded) => {
    return (
      <List
        ...
        <Thumbnail style={{width: 50, height: 50}} source={{uri: url}} />
        ...
        <View>
          ...
          {iscontactSaved && (
            <Text style={{marginLeft: 20, color: 'green'}}>
              <Icon
                style={{color: 'green', fontSize: 15, marginRight: 10}}
                type="FontAwesome"
                name="phone"
              />
              unsaved
    ...
    return (
      ...
      >
        ...
        <View
          ...
          <Button
            rounded
            style={{backgroundColor: 'white', borderRadious: 3}}
          ...
          <Button
            ...
            onPress={() => alert('sms')}>
            <Icon type="FontAwesome" name="paper" style={{color: 'coral'}} />
          </Button>
          <Button
            rounded
            style={{backgroundColor: 'white'}}
